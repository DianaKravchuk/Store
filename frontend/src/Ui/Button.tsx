...
const Button: React.FC<ButtonProps> = ({ text, size }) => {
  ...
  return (
    <button className={`flex items-center justify-center font-inter font-normal text-[16px] leading-6 gap-3 py-[10px] px-[48px] bg-black text-white rounded-full ${sizeClass}`}>
      {text}
