...
const SmallCard: React.FC<CardProps> = ({ id, title, price }) => {
  return (
    <div
      className="size-[331px] bg-[#989899] rounded-3xl p-5 flex flex-col justify-between"
      key={id}
    >
      ...
      <div className="w-full h-[53px] flex justify-between items-center bg-white rounded-[15px] py-1 px-3">
        <div className="flex flex-col">
          ...
          <p className="font-inter font-light leading-5 text-[16px] flex justify-between">
