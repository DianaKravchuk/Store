...
const Header: React.FC = () => {
  ...
  return (
    <header className="w-full h-[104px] flex justify-center items-center bg-[#F4F4F4CC] pt-[60px] z-10 relative">
      <div className="w-[1032px] flex items-center justify-evenly">
        <Link
          to={"/"}
